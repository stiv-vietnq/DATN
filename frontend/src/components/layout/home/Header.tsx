...
export default function Header() {
  ...
  const handleGetAllCartsByUserId = () => {
    if (!userId) return;
    getAllCartsByUserId(Number(userId), "", true)
      .then((response) => {
                ...
                <div className="navbar-container-account-item">
                  {token ? (
                    <div>
                      <div className="navbar-container-account-item">
                        ...
                        <ul className="user-popup">
                          <li onClick={() => handleNavigate("/user/profile")}>
                            {t("my_account")}
                          </li>
                          <li onClick={() => handleNavigate("/user/purchases")}>
                            {t("my_purchases")}
                          </li>
                          {role === "ROLE_ADMIN" && (
                            <li
                              onClick={() =>
                                handleNavigate("/admin/dashboard/default")
                              }
                            >
                              {t("admin_page")}
                            </li>
                    ...
                    <div style={{ display: "flex", gap: "10px" }}>
                      <div
                        className="navbar-container-account-item"
                  ...
                  >
                    ...
                    {cartItems?.length === 0 ? (
                      ...
                      <ul className="cart-popup-list">
                        <div className="cart-popup-list-header">
                          {t("cart")}
                        </div>
                        {cartItems?.map((item) => (
