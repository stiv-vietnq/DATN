...
const CategoryPage = () => {
    ...
    const [categories, setCategories] = useState<CategoryType[]>([
        { id: 1, name: "Danh mục 1", description: "Mô tả danh mục 1", createdDate: "2025-10-01", updatedDate: "2025-10-05", status: true },
        { id: 2, name: "Danh mục 2", description: "Mô tả danh mục 2", createdDate: "2025-09-20", updatedDate: "2025-09-25", status: true },
        { id: 3, name: "Danh mục 3", description: "Mô tả danh mục 3", createdDate: "2025-08-15", updatedDate: "2025-08-20", status: true },
        { id: 4, name: "Danh mục 4", description: "Mô tả danh mục 4", createdDate: "2025-07-12", updatedDate: "2025-07-15", status: true },
        { id: 5, name: "Danh mục 5", description: "Mô tả danh mục 5", createdDate: "2025-07-01", updatedDate: "2025-07-05", status: true },
    ]);
        ...
        { key: "status", label: "Trạng thái", width: "10%" },
        {
            ...
            render: (item: { id: any }) => (
                <div className="action-buttons-category">
                    <FaEye className="action-buttons-icon-category" onClick={() => handleView(item?.id)} />
                    <FaEdit className="action-buttons-icon-category" color="blue" onClick={() => handleEdit(item?.id)} />
                    <FaTrash className="action-buttons-icon-category" color="red" onClick={() => openConfirm("delete", item?.id)} />
                </div>
            ),
        },
    ];
