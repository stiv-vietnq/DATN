...
const UserPage = () => {
    ...
    const handleSearch = () => {
        ...
        searchUsers(params).then((response) => {
    ...
    const columns: BaseColumn<UserTable>[] = [
        ...
        },
        {
            ...
            label: "Thao tác",
            width: "10%",
            render: (item: { email: any, locked: any }) => (
                <div className="action-buttons-category">
                    <FaLock
                        className={`action-buttons-icon-category ${item.locked ? "disabled" : ""}`}
                        color={item.locked ? "gray" : "red"}
                        onClick={() => {
                            if (!item.locked) {
                                setLocked("true");
        ...
        <div className="p-4-category">
            ...
            {showConfirm && (
                <ConfirmModal
                    ...
                    onConfirm={() =>
                        handleLockAccount(selectedId, locked)
                    }
