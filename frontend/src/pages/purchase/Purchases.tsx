  ...
  const handleBuyNow = async () => {
    ...
    try {
      if (customerInfo.paymentMethod === "cod") {
        ...
        const res = await submitOrderVnPay(
          "Payment for order",
          String(totalVND)
        );
        if (res?.data) {
                ...
                <div className="address-popup">
                  ...
                  <div className="address-popup-content-list">
                    {addresses.map((addr) => (
                      <div
                        key={addr.id}
                        className={`address-item-popup ${
                          addressId === addr.id ? "selected" : ""
                        }`}
              ...
              <div key={item.id} className="cart-item">
                ...
                <div style={{ width: "80%" }}>
                  ...
                  >
                    ...
                    <div className="cart-total-purchase">
                      {t("price")}: {item.total}
                    </div>
                  </div>
                </div>
